...
export const dbName = process.env.DB_NAME ?? "url_shortener";
...
export const bannedIds = process.env.BANNED_CUSTOMIDS ? ["home", "about", "info", "tos", "contact", "urls", "credits", "credit", ...process.env.BANNED_CUSTOMIDS.split(" ")] : ["home", "about", "info", "tos", "contact", "urls", "credits", "credit"];